...
overall_title = 'Taylor Figure 12.10:  ' +                 rf' $\omega = {omega_ext:.2f},$' +                 rf' $\gamma = {gamma_ext:.3f},$' +                 rf' $\omega_0 = {omega_0:.2f},$' +                 rf' $\beta = {beta:.2f},$' +                 rf'  $\phi_0 = {phi_0:.2f},$' +                 rf' $\dot\phi_0 = {phi_dot_0:.2f}$' +                 '\n'     # \n means a new line (adds some space here)
...
overall_title = 'Taylor figure 12.11:  ' +                 rf' $\omega = {omega_ext:.2f},$' +                 rf' $\gamma = {gamma_ext:.3f},$' +                 rf' $\omega_0 = {omega_0:.2f},$' +                 rf' $\beta = {beta:.2f}$' +                 '\n'     # \n means a new line (adds some space here)
fig.suptitle(overall_title, va='baseline')
...
# start the plot!
fig = plt.figure(figsize=(10,10))
overall_title = 'Taylor figure 12.12:  ' +                 rf' $\omega = {omega_ext:.2f},$' +                 rf' $\gamma = {gamma_ext:.3f},$' +                 rf' $\omega_0 = {omega_0:.2f},$' +                 rf' $\beta = {beta:.2f}$' +                 '\n'     # \n means a new line (adds some space here)
fig.suptitle(overall_title, va='baseline')
...
# start the plot!
fig = plt.figure(figsize=(10,10))
overall_title = 'Taylor figure 12.13:  ' +                 rf' $\omega = {omega_ext:.2f},$' +                 rf' $\gamma = {gamma_ext:.3f},$' +                 rf' $\omega_0 = {omega_0:.2f},$' +                 rf' $\beta = {beta:.2f}$' +                 '\n'     # \n means a new line (adds some space here)
fig.suptitle(overall_title, va='baseline')
...
# start the plot!
fig = plt.figure(figsize=(10,10))
overall_title = 'Taylor figure 12.14:  ' +                 rf' $\omega = {omega_ext:.2f},$' +                 rf' $\gamma = {gamma_ext:.3f},$' +                 rf' $\omega_0 = {omega_0:.2f},$' +                 rf' $\beta = {beta:.2f}$' +                 '\n'     # \n means a new line (adds some space here)
fig.suptitle(overall_title, va='baseline')
...
# start the plot!
fig = plt.figure(figsize=(10,10))
overall_title = 'Taylor figure 12.15:  ' +                 rf' $\omega = {omega_ext:.2f},$' +                 rf' $\gamma = {gamma_ext:.3f},$' +                 rf' $\omega_0 = {omega_0:.2f},$' +                 rf' $\beta = {beta:.2f}$' +                 '\n'     # \n means a new line (adds some space here)
fig.suptitle(overall_title, va='baseline')
...
# start the plot!
fig = plt.figure(figsize=(10,10))
overall_title = 'Taylor figure 12.15b:  ' +                 rf' $\omega = {omega_ext:.2f},$' +                 rf' $\gamma = {gamma_ext:.3f},$' +                 rf' $\omega_0 = {omega_0:.2f},$' +                 rf' $\beta = {beta:.2f}$' +                 '\n'     # \n means a new line (adds some space here)
fig.suptitle(overall_title, va='baseline')
