...
# 
# $\begin{align}
#   S[y(x)] = \int_{x_1}^{x_2} f[y(x), y'(x), x] \, dx
# \end{align}$
# 
...
# 
# This problem states: "Find the equation of the path from the origin $O$ to the point $P(1,1)$ in the $xy$ plane that makes the integral $\int_O^P (y'^2 + y y' + y^2) dx$ stationary.  The answer from solving the Euler-Lagrange equation is $y^*(x) = \sinh(x)/\sinh(1)$.
